/**
 * SQLite database access layer for the NAIH MCP server.
 *
 * Schema:
 *   - decisions    — NAIH határozatok (decisions), sanctions, and orders
 *   - guidelines   — NAIH guidance documents and tájékoztatók
